...
candy palette with real light, glossy materials with soft contact shadows, a
warm cream stage with confetti. Regenerate with `./gradlew :tools:makeArt`;
never edit the PNGs by hand.

- `play-store/feature-graphic-1024x500.png`: toy-lettered title with candy
  underline bars, and the hero fact: two red balls plus three teal ones,
  wearing their counting chips, equalling a giant glossy five.
- `play-store/play-icon-512.png`: five glossy balls packed two over three on
  the radial blue: the parts inside the whole they make.
