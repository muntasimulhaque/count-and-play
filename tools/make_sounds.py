...
if __name__ == "__main__":
    ...
    write("sfx_tick", tick(), peak=0.55)
    write("sfx_thud", thud(), peak=0.75)
    write("sfx_rustle", rustle(), peak=0.55)
    write("sfx_hollow", hollow(), peak=0.50)
    write("sfx_clink", clink(), peak=0.62)
    write("sfx_chime", chime(), peak=0.70)
