...
object BnPack : LangPack {
    ...
    override fun levelUp(cap: Int) = "দারুণ! এবার ${word(cap)} পর্যন্ত গুনব!"
    override fun voicePreview() = "নমস্কার! চলো গুনো!"
    override fun slowVoice() = "ধীর গলা।"
    override fun normalVoice() = "স্বাভাবিক গলা।"
    override fun howManyLeftPrompt() = "কয়টি বাকি আছে?"
    override fun howManyLeftCount() = "কয়টি বাকি আছে? গুনো!"
    ...
    override fun plusOrMinus() = "যোগ নাকি বাদ?"
    override fun plusWord() = "যোগ"
    override fun minusWord() = "বাদ"
    ...
    override fun countTogether() = "চলো একসাথে গুনো!"
    ...
    override fun nowCountingTo(cap: Int) = "এবার ${digits(cap)} পর্যন্ত গুনব!"
    override fun surprise() = "🎲 অবাক করো!"
    ...
    override fun no() = "✖ না"
    override fun noVoiceNote() = "এই ডিভাইসে বাংলা গলা নেই — ডিফল্ট গলা ব্যবহার হচ্ছে।"
